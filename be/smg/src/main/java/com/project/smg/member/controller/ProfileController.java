...
//            return new ResponseEntity<>(new ResponseDto(500, "BigGoal 목록이 존재하지 않습니다."), HttpStatus.OK);
//        }
    }
...
//            return new ResponseEntity<>(new ResponseDto(500, "ClearDto 목록이 존재하지 않습니다."), HttpStatus.OK);
//        }
    }
...
//            return new ResponseEntity<>(new ResponseDto(500, "ClearMandalartDto 목록이 존재하지 않습니다."), HttpStatus.OK);
//        }
    }
